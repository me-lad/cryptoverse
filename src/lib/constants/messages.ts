export const Messages = {
  Error: {
    ...
    DuplicatePhoneNumber:
      'There is already an account registered with the entered Phone Number.',
    ...
    NotVerifiedAccount:
      "Your account hasn't been verified yet. pls verify it first.",
  ...
  Success: {
    ...
    CompleteVerify:
      "Verification has successfully done. you' ll be redirecting to your dashboard.",
    CompleteResetPassword:
      'Your password changed successfully. Please signin with new data.',
  },
} as const;
